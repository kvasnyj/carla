...
(cl:defmethod cl:initialize-instance :after ((m <CarControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name styx_msgs-msg:<CarControl> is deprecated: use styx_msgs-msg:CarControl instead.")))
...
(cl:defmethod throttle-val ((m <CarControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader styx_msgs-msg:throttle-val is deprecated.  Use styx_msgs-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <CarControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader styx_msgs-msg:steer-val is deprecated.  Use styx_msgs-msg:steer instead.")
  (steer m))
